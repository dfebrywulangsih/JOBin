...
<head>
<meta charset="utf-8">
<title>JOBin / <?php echo $title;?></title>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">JOBin<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          JOBin Company<br>
           Surabaya, Indonesia.</address>
          <p>
            <i class="icon-phone"></i> 0821-3960-1000<br>
            <i class="icon-envelope-alt"></i> natasyaekadamayanti@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; JOBin 2024 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
